...
public class RelayCommand<T> : ICommand
{
    ...
    {
        Logger.Info("Call command"); // TODO: command name should be given here
        ...
        _execute((T?) parameter);
            ...
            {
                Logger.Fatal(e, "Executing command failed with exception."); // command name is missing here

                Kapok.View.ViewDomain.Default?.ShowErrorMessage("Executing command failed with exception", exception: e);
            }
#endif
    }
}