...
namespace Infralution.Localization.Wpf
{
    ...
    public abstract class ManagedMarkupExtension : MarkupExtension
    {
        ...
        {
            if (_targetProperty is DependencyProperty dependencyProperty)
            {
            ...
            else if (_targetProperty is PropertyInfo propertyInfo)
            {
        ...
        /// </remarks>
        protected List<WeakReference> TargetObjects => _targetObjects;
        ...
        protected Type TargetPropertyType
        {
            get
            {
                Type result = null;
                if (_targetProperty is DependencyProperty dependencyProperty)
                    result = dependencyProperty.PropertyType;
                else if (_targetProperty is PropertyInfo propertyInfo)
