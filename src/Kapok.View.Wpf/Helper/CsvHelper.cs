...
// TODO: CsvHelper is twice implemented: one in Kapok.View.Wpf and once in Kapok.DataPort!!!
public class CsvHelper
{
    ...
    public static LineSeparator GuessCsvSeparator(string oneLine)
    {
        ...
        listOfLineSeparatorAndThereFirstLineSeparatedValueCount.Add(new Tuple<LineSeparator, int>(LineSeparator.Tab, ParseLineTabSeparated(oneLine).Count()));
        listOfLineSeparatorAndThereFirstLineSeparatedValueCount.Add(new Tuple<LineSeparator, int>(LineSeparator.Semicolon, ParseLineSemicolonSeparated(oneLine).Count()));
        listOfLineSeparatorAndThereFirstLineSeparatedValueCount.Add(new Tuple<LineSeparator, int>(LineSeparator.Comma, ParseLineCommaSeparated(oneLine).Count()));
